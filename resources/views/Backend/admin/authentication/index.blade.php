...
@section('content')
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/authentication/index')}}"><cite>全部地区</cite></a>
        {{--<a href="{{url('admin/authentication/create')}}" class="layui-btn layui-btn-small" id="add">
        <i class="layui-icon">&#xe608;</i> 添加地区
    </a>--}}
    </blockquote>
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">用户</th>
                    <th data-sortable="false">身份</th>
                    <th data-sortable="false">身份证</th>
                    <th data-sortable="false">有效期</th>
                    <th data-sortable="false">类型</th>
                    <th data-sortable="false">状态</th>
                    <th data-sortable="false">日期</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/authentication/index')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        {
                            ...
                            var html = '<a style="margin:3px;" href="/admin/authentication/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            /*  html += '<a style="margin:3px;" href="/admin/authentication/create?parent_id=' + row.id + '" title="添加"><i class="layui-icon">&#xe61f;</i></a>';*/
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/authentication/del/?id=')}}'+id,
                    });
                }
            });
        }
