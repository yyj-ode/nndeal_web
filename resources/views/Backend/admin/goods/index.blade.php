...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            ...
            <a href="{{url('admin/goods/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">服务名称</th>
                    <th data-sortable="false">价格（元）</th>
                    <th data-sortable="false">服务内容</th>
...
//                            var html = '<a style="margin:3px;" href="/admin/category/index?parent_id=' + row.id + '" class="X-Small btn-xs text-success" title="查看"><i class="linyer icon-qiyong"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/goods/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/goods/del/?id=')}}'+id,
                    });
                }
            });
