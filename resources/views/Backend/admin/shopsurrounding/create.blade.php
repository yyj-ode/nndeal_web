            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show" style="height: 400px;">
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" autocomplete="off" placeholder="请输入单价" class="layui-input" value="">
                        </div>
                    </div>
...
//                loadShow();
                $.ajax({
                    url: "{{url('admin/shopsurrounding/store')}}",
                    type: 'post',
                    data: data.field,
                    headers: { 'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content') },
                    success:function(result){
                            ...
                            layer.open({
                                ...
                                success: function(layero){
                                    ...
                                    btn.find('.layui-layer-btn1').attr({
                                        href: '{{url('admin/shopsurrounding/create')}}',
                                    });
                                    layer.close(layero);
                                }
                            });
