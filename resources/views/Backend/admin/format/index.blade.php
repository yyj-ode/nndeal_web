...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            <a href="{{url('admin/format/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/format/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/format/update?_id=' + row._id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            return html;
                        }
                        }
                    ],
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/format/del/?id=')}}'+id,
                    });
                }
            });
        }
