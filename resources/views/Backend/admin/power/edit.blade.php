...
@section('content')
    <div style="margin: 15px;">
        <blockquote class="layui-elem-quote">
            <a class="layui-btn layui-btn-small" href="{{url('admin/roles')}}"><cite>全部权限</cite></a>
        </blockquote>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="email" lay-verify="title" autocomplete="off" placeholder="请输邮箱" class="layui-input" disabled="disabled" value="{{$result->email}}">
            </div>
        </div>
