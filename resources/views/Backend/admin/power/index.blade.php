...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/power/index')}}"><cite>全部角色</cite></a>
            ...
            <a href="{{url('admin/power/create')}}" class="layui-btn layui-btn-small" id="add">
            ...
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/power/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/power/create" title="添加"><i class="linyer icon-xgpwd2"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/power/del/?id=')}}'+id,
                    });
                }
            });
        }
