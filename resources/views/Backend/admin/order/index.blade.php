        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">商品</th>
                    <th data-sortable="false">总金额</th>
                    <th data-sortable="false">实际支付</th>
                    ...
                    columnDefs: [
                        {
                           ...
                           /* var html = '<a style="margin:3px;" href="/admin/order/edit?id=' + row.id + '" title="重置密码"><i class="linyer icon-xgpwd2"></i></a>';*/
                           var html = '<a onclick="del('+row.id+')" style="margin:3px;"><i class="linyer icon-delect"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/order/del/?id=')}}'+id,
                    });
                }
            });
