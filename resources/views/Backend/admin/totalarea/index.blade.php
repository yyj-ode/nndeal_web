...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            <a href="{{url('admin/totalarea/create')}}" class="layui-btn layui-btn-small" id="add">
            <i class="layui-icon">&#xe608;</i> 添加面积
        </a>
    </blockquote>
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">最小面积（m²）</th>
                    <th data-sortable="false">最大面积（m²）</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/totalarea/indexdata')}}",
                        type: "POST",
                        headers: {
...
//                            var html = '<a style="margin:3px;" href="/admin/category/index?parent_id=' + row.id + '" class="X-Small btn-xs text-success" title="查看"><i class="linyer icon-qiyong"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/totalarea/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/totalarea/del/?id=')}}'+id,
                    });
                }
            });
