    ...
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="min_area" lay-verify="title" autocomplete="off" placeholder="请输入最小面积" class="layui-input" value="{{$result['min_area']}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="max_area" lay-verify="title" autocomplete="off" placeholder="请输入最大面积" class="layui-input" value="{{$result['max_area']}}">
            </div>
        </div>
                            ...
                            layer.open({
                                ...
                                success: function(layero){
                                    ...
                                    btn.find('.layui-layer-btn0').attr({
                                        href: '{{url('admin/totalarea')}}',
                                        target: '_self'
                                    });
                                    btn.find('.layui-layer-btn1').attr({
                                        href: '{{url("admin/totalarea/update?id=$result[id]")}}',
                                    });
                                    layer.close(layero);
                                }
                            });
