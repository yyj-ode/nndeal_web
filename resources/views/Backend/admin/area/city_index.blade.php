...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/area/index')}}"><cite>全部地区</cite></a>
            ...
            <a href="javascript:history.back();" class="layui-btn layui-btn-small" id="add">
            <i class="layui-icon"></i> 返回
        </a>
    </blockquote>

    <fieldset class="layui-elem-field">
        <legend>数据列表-{{$cat_name->name}}</legend>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/area/city_index')}}",
                        type: "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
                        },
                        data: {
                            parent_id: '{{$parent_id}}',cat_id: '{{$cat_id}}',
                        }
                    },
                    columns: [
                        {"data": "id"},
                    ...
                    columnDefs: [
                        {
                            ...
                            var html = '<a style="margin:3px;" href="/admin/area/county_index?cat_id=' + row.id + '" class="X-Small btn-xs text-danger" title="查看"><i class="layui-icon"></i>查看</a>&nbsp;&nbsp;&nbsp;';
