...
@section('content')
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="view_order" lay-verify="required" autocomplete="off" placeholder="请输排序" class="layui-input" value="{{$result->view_order}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="shorthand" lay-verify="required" autocomplete="off" placeholder="请输简写" class="layui-input" value="{{$result->shorthand}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="show"  @if($result->show == 1) checked="checked" @endif value="1" title="显示" >
                <input type="radio" name="show" value="0" @if($result->show == 0) checked="checked" @endif title="不显示" >
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">描述</label>
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" lay-verify="text" name="description"  id="LAY_demo_editor">{{$result['description']}}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
>>>>>>> kim
                                    ...
                                    btn.find('.layui-layer-btn1').attr({
                                        href: "{{url('admin/area/update?id='.$result->id)}}",
                                        target: '_self'
                                    });
                                    layer.close(layero);
                                }
