...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        ...
        @if($parent_id)
            <a class="layui-btn layui-btn-small" href="{{url('admin/area/create?parent_id='.$parent_id)}}"><cite>添加</cite></a>
...
<<<<<<< HEAD
                            var html = '<a style="margin:3px;" href="/admin/area/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/area/create?parent_id=' + row.id + '" title="添加"><i class="linyer icon-xgpwd2"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/area/index?parent_id=' + row.id + '" title="查看"><i class="linyer icon-qiyong"></i></a>';
=======
                            var html = '<a style="margin:3px;" href="/admin/area/city_index?cat_id=' + row.id + '" class="X-Small btn-xs text-danger" title="查看"><i class="layui-icon"></i>查看</a>&nbsp;&nbsp;&nbsp;';
                            html += '<a style="margin:3px;" href="/admin/area/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>&nbsp;&nbsp;&nbsp;';
                            html += '<a style="margin:3px;" href="/admin/area/create?parent_id=' + row.id + '" title="添加"><i class="layui-icon">&#xe61f;</i></a>&nbsp;&nbsp;&nbsp;';
>>>>>>> lihaowei
