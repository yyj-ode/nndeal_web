...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            ...
            <a href="{{url('admin/collection/create')}}" class="layui-btn layui-btn-small" id="add">
            <i class="layui-icon">&#xe608;</i> 添加收藏
        </a>
    </blockquote>
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">用户姓名</th>
                    <th data-sortable="false">商铺名称</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/collection/indexdata')}}",
                        type: "POST",
                        headers: {
...
//                            title: "用户ID",
//                            render: function (data, type, row, meta) {
//                                return "<a href='/question/c" + row.id + "s6p1.html' target='_blank'>" + row.users_id + "</a>"
//                            }
//                        },
                        {
...
//                            var html = '<a style="margin:3px;" href="/admin/category/index?parent_id=' + row.id + '" class="X-Small btn-xs text-success" title="查看"><i class="linyer icon-qiyong"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/collection/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/collection/del/?id=')}}'+id,
                    });
                }
            });
