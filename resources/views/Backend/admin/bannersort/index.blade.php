...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        ...
        <a href="{{url('admin/bannersort/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/bannersort/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        {
                            ...
                            var html = '<a style="margin:3px;" href="/admin/bannersort/index?parent_id=' + row.id + '" class="X-Small btn-xs text-success" title="查看"><i class="linyer icon-qiyong"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/bannersort/' + row.id + '/edit" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/bannersort/create?parent_id=' + row.id + '" title="添加"><i class="linyer icon-xgpwd2"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/bannersort/' + row.id + '/edit"><i class="linyer icon-delect"></i></a>';
                            return html;
                        }
                        }
                    ],
