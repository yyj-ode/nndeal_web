...
@section('content')
    <div style="margin: 15px;">
        ...
        {{ Form::open(array('url' => 'admin/friendshipsort/update', 'method' => 'POST','class'=>'layui-form',)) }}
        {!! csrf_field() !!}
        <div class="layui-form-item">
            <label class="layui-form-label">分类名称</label>
            <div class="layui-input-block">
                <input type="text" name="sort_name" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" value="{{$result->sort_name}}">
            </div>
        </div>
    ...
    <script type="text/javascript">
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            form.on('submit(submit)', function(data) {
                loadShow();
                $.ajax({
                    url: "{{url('admin/friendshipsort/update')}}",
                    type: 'post',
                    data: {
