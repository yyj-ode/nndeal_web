                    ...
                    columnDefs: [
                        {
                            ...
                            var html = '<a style="margin:3px;" href="/admin/admin/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/admin/edit?id=' + row.id + '" title="添加"><i class="linyer icon-xgpwd2"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/admin/del/?id=')}}'+id,
                    });
                }
            });
