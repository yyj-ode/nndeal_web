            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show" style="height: 750px;">
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="office_name" autocomplete="off" placeholder="请输入名称" class="layui-input" value="{{$result['office_name']}}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="office_address" autocomplete="off" placeholder="请输入地址" class="layui-input" value="{{$result['office_address']}}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="company_categories" autocomplete="off" placeholder="请输入类型" class="layui-input" value="{{$result['company_categories']}}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="rent_rate" autocomplete="off" placeholder="请输入价格" class="layui-input" value="{{$result['rent_rate']}}">
                        </div>
                    </div>
...
//                loadShow();
                $.ajax({
                    url: "{{url('admin/officebuilding/doupdate')}}",
                    type: 'post',
                    data: data.field,
