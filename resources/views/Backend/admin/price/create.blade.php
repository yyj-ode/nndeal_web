    ...
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="min_price" lay-verify="title" autocomplete="off" placeholder="请输入最小金额" class="layui-input" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="max_price" lay-verify="title" autocomplete="off" placeholder="请输入最大金额" class="layui-input" value="">
            </div>
        </div>
