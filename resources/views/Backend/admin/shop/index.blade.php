...
@section('content')
    ...
    {{--<blockquote class="layui-elem-quote">--}}
        {{--<a class="layui-btn layui-btn-small" href="{{url('admin/shop')}}"><cite>全部店铺</cite></a>--}}

            {{--<a href="{{url('admin/shop/create')}}" class="layui-btn layui-btn-small" id="add">--}}
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">店铺名称</th>
                    <th data-sortable="false">店主姓名</th>
                    <th data-sortable="false">店主电话</th>
                    <th data-sortable="false">主营小区</th>
                    <th data-sortable="false">好评率</th>
...
//                        },
                        {
                            ...
                            var html = '';
//                            var html = '<a style="margin:3px;" href="/admin/category/index?parent_id=' + row.id + '" class="X-Small btn-xs text-success" title="查看"><i class="linyer icon-qiyong"></i></a>';
//                            html += '<a style="margin:3px;" href="/admin/shop/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
