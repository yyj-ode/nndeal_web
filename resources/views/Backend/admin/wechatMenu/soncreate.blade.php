    ...
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入子菜单名称" class="layui-input" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" lay-verify="required" autocomplete="off" placeholder="请输URL" class="layui-input" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sort" lay-verify="required" autocomplete="off" placeholder="" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
    ...
    <script type="text/javascript">
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            form.on('submit(submit)', function(data) {
                ...
                loadShow();
                $.ajax({
                    url: "{{url('admin/wechatMenu/storeson')}}",
                    type: 'post',
                    data: data.field,
                            ...
                            layer.open({
                                ...
                                success: function(layero){
                                    ...
                                    btn.find('.layui-layer-btn1').attr({
                                        href: '{{url("admin/wechatMenu/soncreate?parent_id=$parent_id")}}',
                                    });
                                    layer.close(layero);
                                }
                            });
