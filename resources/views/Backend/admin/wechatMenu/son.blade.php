...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/wechatMenu/index')}}"><cite>全部菜单</cite></a>
            ...
            <a href='{{url("admin/wechatMenu/soncreate?parent_id=$parent_id")}}' class="layui-btn layui-btn-small" id="add">
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/wechatMenu/indexDataSon')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/wechatMenu/updateson?id=' + row.id + '&parent_id='+row.parent_id+'" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/wechatMenu/del/?id=')}}'+id+'&parent_id={{$parent_id}}',
                    });
                }
            });
        }
