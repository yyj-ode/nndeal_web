...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            <a href="{{url('admin/shopline/create')}}" class="layui-btn layui-btn-small" id="add">
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th data-sortable="false">房主姓名</th>
                    <th data-sortable="false">房主电话</th>
                    <th class="sorting">房屋区域</th>
                    <th class="sorting">租赁类型</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/shopline/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/shopline/update?_id=' + row._id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/shopline/del/?_id=')}}'+id,
                    });
                }
            });
        }
