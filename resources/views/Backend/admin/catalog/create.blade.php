...
@section('content')
    <div style="margin: 15px;">
        ...
        {{ Form::open(array('url' => 'admin/catalog/store', 'method' => 'POST','class'=>'layui-form',)) }}
        {!! csrf_field() !!}
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="icon" lay-verify="required" autocomplete="off" placeholder="请输用户名称" class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="sort" lay-verify="int" value="0" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">状态</label>
            <div class="layui-input-block">
                <input type="radio" name="status" checked="checked" value="1" title="开启" >
