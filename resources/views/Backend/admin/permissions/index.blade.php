...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/permissions/index')}}"><cite>全部权限</cite></a>
            ...
            <a href="{{url('admin/permissions/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">标签</th>
                    <th data-sortable="false">类别</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/permissions/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/permissions/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/permissions/create" title="添加"><i class="layui-icon">&#xe608;</i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/permissions/del/?id=')}}'+id,
                    });
                }
            });
        }
