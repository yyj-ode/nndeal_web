            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show" style="height: 750px;">
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="longitude" autocomplete="off" placeholder="请输入经度" class="layui-input" value="{{$result['longitude']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="latitude" autocomplete="off" placeholder="请输入纬度" class="layui-input" value="{{$result['latitude']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="province" class="one select" lay-filter="one" disabled="disabled">
                        ...
                        <div class="layui-input-inline"  @if( !($result->city))style="display: none;" @endif id="tow_input">
                            <select name="city"  class="tow select" lay-filter="tow" id="tow" disabled="disabled">
                                <option value="">请选择</option>
                        ...
                        <div class="layui-input-inline" @if( !($result->county))style="display: none;" @endif id="three_input">
                            <select name="county" class="three select" lay-filter="three" id="three" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="adress" autocomplete="off" placeholder="请输入地址" class="layui-input" value="{{$result['adress']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="building_category" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="floor_level" autocomplete="off" placeholder="请输入楼层" class="layui-input" value="{{$result['floor_level']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="area" autocomplete="off" placeholder="请输入面积" class="layui-input" value="{{$result['area']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="floor_height" autocomplete="off" placeholder="请输入层高" class="layui-input" value="{{$result['floor_height']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="door_width" autocomplete="off" placeholder="请输入门宽" class="layui-input" value="{{$result['door_width']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="depth" autocomplete="off" placeholder="请输入进深" class="layui-input" value="{{$result['depth']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="current_status" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="license" disabled="disabled">
                                <option value="">请选择</option>
                ...
                <div class="layui-tab-item" style="height: 400px;">
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="water_supply_and_drainage" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="electricity" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="gas_tube" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="smoke_tube" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="sewage" disabled="disabled">
                                <option value="">请选择</option>
                    ...
                    <div class="layui-form-item" style="width: 400px;">
                        ...
                        <div class="layui-input-inline">
                            <select name="flame" disabled="disabled">
                                <option value="">请选择</option>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="leasing_duration" autocomplete="off" placeholder="请输入年限(月)" class="layui-input" value="{{$result['leasing_duration']}}" readonly="true">
                        </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="payment_type" autocomplete="off" placeholder="请输入付款方式" class="layui-input" value="{{$result['payment_type']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="leasing_payment" autocomplete="off" placeholder="请输入转让费" class="layui-input" value="{{$result['leasing_payment']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="rent" autocomplete="off" placeholder="请输入月租" class="layui-input" value="{{$result['rent']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" style="width: 300px;">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="progressive_rate" autocomplete="off" placeholder="请输入递增幅度" class="layui-input" value="{{$result['progressive_rate']}}" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <span id="image_upload_src">
                            @if($result->photo)
                                <img src="{{$result->photo}}" style="width:60px;height:60px;padding:2px;"><input type="hidden" name="image" value="{{$result->photo}}"><i class="fa fa-close"></i>
                            @endif
                        </span>
                    </div>
                </div>
