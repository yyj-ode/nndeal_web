...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/account/index')}}"><cite>全部用户</cite></a>
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">昵称</th>
                    <th data-sortable="false">姓名</th>
                    <th data-sortable="false">性别</th>
                    <th data-sortable="false">年龄</th>
                    <th data-sortable="false">省份</th>
                    <th data-sortable="false">城市</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/account/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        {
                            ...
                            var html = '<a style="margin:3px;" href="/admin/account/edit?id=' + row.id + '" title="重置密码"><i class="linyer icon-xgpwd2"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/account/del/?id=')}}'+id,
                    });
                }
            });
