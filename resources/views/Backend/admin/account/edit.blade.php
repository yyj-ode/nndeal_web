...
@section('content')
    <div style="margin: 15px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="account" lay-verify="title" autocomplete="off"  class="layui-input" disabled="disabled" value="{{$result->account}}">
            </div>
        </div>
                            ...
                            layer.open({
                                ...
                                success: function(layero){
                                    ...
                                    btn.find('.layui-layer-btn0').attr({
                                        href: '{{url('admin/account/index')}}',
                                        target: '_self'
                                    });
                                    btn.find('.layui-layer-btn1').attr({
                                        href: "{{url('admin/account/edit/?id='.$result->id)}}",
                                        target: '_self'
                                    });
                                    layer.close(layero);
                                }
