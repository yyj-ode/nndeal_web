...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/category')}}"><cite>全部分类</cite></a>
            ...
            <a href="{{url('admin/category/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">关键字</th>
                    <th data-sortable="false">分类描述</th>
                    <th class="sorting">分类父ID</th>
                    <th class="sorting">排序I</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/category/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            title: "标题",
                            render: function (data, type, row, meta) {
                                return "<a href='/question/c" + row.id + "s6p1.html' target='_blank'>" + row.title + "</a>"
                            }
                        },
                        {
                            ...
                            html += '<a style="margin:3px;" href="/admin/category/' + row.id + '/edit" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/category/create?parent_id=' + row.id + '" title="添加"><i class="linyer icon-xgpwd2"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/category/' + row.id + '/edit"><i class="linyer icon-delect"></i></a>';
                            return html;
                        }
                        }
                    ],
