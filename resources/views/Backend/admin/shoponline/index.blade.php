...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
            <a href="{{url('admin/shoponline/create')}}" class="layui-btn layui-btn-small" id="add">
            <i class="layui-icon">&#xe608;</i> 添加街铺
        </a>
    </blockquote>
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">店铺地址</th>
                    <th class="sorting">销售份数（份）</th>
                    <th class="sorting">线上销售额（元）</th>
        ...
        layui.use(['jquery', 'form', 'layedit', 'laydate'], function () {
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    order: [[0, "desc"]],
                    ajax: {
                        url: "{{url('admin/shoponline/indexdata')}}",
                        type: "POST",
                        headers: {
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/shoponline/update?_id=' + row._id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" onclick="del(\''+row._id+'\')"><i class="linyer icon-delect"></i></a>';
                            return html;
                        }
                        }
                    ],
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/shoponline/del/?_id=')}}'+id,
                    });
                }
            });
        }
