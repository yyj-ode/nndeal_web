...
@section('content')
    ...
    <blockquote class="layui-elem-quote">
        <a class="layui-btn layui-btn-small" href="{{url('admin/roles/index')}}"><cite>全部角色</cite></a>
            ...
            <a href="{{url('admin/roles/create')}}" class="layui-btn layui-btn-small" id="add">
        ...
        <div class="no-footer layui-field-box">
            <table id="contents" class="site-table table-hover" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-sortable="false">英文</th>
                    <th data-sortable="false">中文</th>
            ...
            $(function () {
                var contents = $("#contents").DataTable({
                    ...
                    columnDefs: [
                        ...
                        var html = '<a style="margin:3px;" href="/admin/roles/update?id=' + row.id + '" class="X-Small btn-xs text-danger" title="修改"><i class="linyer icon-edit"></i></a>';
                            html += '<a style="margin:3px;" href="/admin/roles/permissions?id=' + row.id + '" title="添加权限">权限<i class="linyer icon-xgpwd2"></i></a>';
            ...
            layer.open({
                ...
                ,success: function(layero){
                    ...
                    btn.find('.layui-layer-btn0').attr({
                        href: '{{url('admin/roles/del/?id=')}}'+id,
                    });
                }
            });
        }
