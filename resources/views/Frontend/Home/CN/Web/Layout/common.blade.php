...
<head>
    ...
    @include('Frontend.Home.CN.Web.Layout.header_index')

</head>
<body>
@yield('reminder')
<div class="box">
    @include('Frontend.Home.CN.Web.Layout.topNav')
    @yield('header')
    @yield('banner')
    @yield('content')
</div>
@include('Frontend.Home.CN.Web.Layout.footer')
@yield("javascript")
@include('Frontend.Home.CN.Web.Layout.error')
</body>
</html>