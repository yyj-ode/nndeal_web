...
$(document).ready(function(e) {
    ...
    $('.share').SmohanPopLayer({Shade : true,Event:'click',Content : 'Share', Title : $('#article_title').html()});
    ...
    var share_from = encodeURIComponent("云研社"); //分享自（仅用于QQ空间和朋友网，新浪的只需更改appkey 和 ralateUid就行）
    //Qzone
...
function addfavorite(){
    var Url = "http://www.yunyanshe.com/";
    var Title = "云研社";
    if(document.all){
